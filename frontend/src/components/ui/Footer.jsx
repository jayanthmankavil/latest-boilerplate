        ...
        >
          ...
          <div className="space-y-2 sm:col-span-12 lg:col-span-4">
            ...
            <div className="text-sm text-gray-600">
              &copy; devblink.com - All rights reserved.
            </div>
          </div>
